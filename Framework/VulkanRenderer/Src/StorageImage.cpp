...
StorageImage::StorageImage(VkPhysicalDevice physicalDevice, VkDevice device, StorageImage::StorageImageParams params)
{
	...
	mImage = new Image(device, params.type, params.format, params.size, params.numMipMaps, params.numLayers, VK_SAMPLE_COUNT_1_BIT, params.usage | VK_IMAGE_USAGE_SAMPLED_BIT, false);
