...
{
	mImage = new Image(device, VK_IMAGE_TYPE_2D, VK_FORMAT_R8G8B8A8_UNORM, { size.width, size.height, 1 }, numMipMaps, 6, VK_SAMPLE_COUNT_1_BIT, usage, true);
	...
	mImageView = new ImageView(device, mImage->getImage(), VK_IMAGE_VIEW_TYPE_2D, VK_FORMAT_R8G8B8A8_UNORM, aspect);
}
