...
VulkanInstance::VulkanInstance(StartupParameters startupInfo)
{
	...
	DesiredExtensions& desiredExtensions = startupInfo.mInstanceExtensions;
...
void SingularityEngine::Graphics::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
	createInfo = {};
