...
{
	mImage = new Image(device, VK_IMAGE_TYPE_2D, format, {size.width, size.height, 1}, numMipMaps, numLayers, samples, usage, false);
	...
	mImageView = new ImageView(device, mImage->getImage(), VK_IMAGE_VIEW_TYPE_2D, format, aspect);
}
